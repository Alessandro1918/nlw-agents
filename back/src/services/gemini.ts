...
export async function generateAnswer(
  ...
  `.trim()
  //if provided at least 1 audio chunk in this array of transcriptions, an answer will be created. It will probably never answer "Não tenho informações suficientes para responder"
